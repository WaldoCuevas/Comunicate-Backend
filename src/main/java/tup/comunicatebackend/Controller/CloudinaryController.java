package tup.comunicatebackend.Controller;
...
import tup.comunicatebackend.Service.CloudinaryService;
import tup.comunicatebackend.Service.ImagenService;
...
public class CloudinaryController {
    ...
    public ResponseEntity<?> delete (@PathVariable int id) throws IOException {
        ...
        Map result = cloudinaryService.delete(imagen.getImageId());
